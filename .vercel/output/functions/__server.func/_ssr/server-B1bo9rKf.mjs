...
import { A as isRedirect, D as resolveManifestAssetLink, E as getStylesheetHref, I as invariant, N as rootRouteId, O as resolveManifestCssLink, P as isNotFound, T as getScriptPreloadAttrs, a as replaceSsrResponse, d as RouterProvider, i as normalizeSsrResponse, j as isResolvedRedirect, k as executeRewriteInput, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CGQmTVlS.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BlgsMwi0.mjs"),
		import("./start-BvzAd51o.mjs"),
