...
import { d as require_react, l as useFloating, n as autoPlacement, o as offset, r as flip, s as shift, t as arrow, u as require_react_dom } from "./@floating-ui/react-dom+[...].mjs";
import { r as autoUpdate } from "./@floating-ui/dom+[...].mjs";
import { y as require_shim } from "./@tanstack/react-router+[...].mjs";
import { t as equal } from "./gilbarbara__deep-equal.mjs";
import { a as useWindowSize, i as useUpdateEffect, n as useMount, r as usePrevious, t as useMemoDeepCompare } from "./gilbarbara__hooks.mjs";
import { t as index_default } from "./is-lite.mjs";
import { t as require_react_innertext } from "./react-innertext.mjs";
import { t as require_deepmerge } from "./fastify__deepmerge.mjs";
//#region node_modules/scroll/index.js
var require_scroll = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var E_NOSCROLL = /* @__PURE__ */ new Error("Element already at target scroll position");
	var E_CANCELLED = /* @__PURE__ */ new Error("Scroll cancelled");
	var min = Math.min;
	var ms = Date.now;
	module.exports = {
	...
	function make(prop) {
		return function scroll(el, to, opts, cb) {
			...
			function animate(timestamp) {
				...
				var time = min(1, (ms() - start) / duration);
...
//#endregion
//#region node_modules/scrollparent/scrollparent.js
var require_scrollparent = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/react-joyride/dist/index.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_shim = require_shim();
var import_react_innertext = /* @__PURE__ */ __toESM(require_react_innertext(), 1);
var import_deepmerge = /* @__PURE__ */ __toESM(require_deepmerge(), 1);
var import_scroll = /* @__PURE__ */ __toESM(require_scroll(), 1);
var import_scrollparent = /* @__PURE__ */ __toESM(require_scrollparent(), 1);
...
function deepMerge(...objects) {
	return (0, import_deepmerge.default)({
		all: true,
		isMergeableObject: (value) => !(!index_default.plainObject(value) || (0, import_react.isValidElement)(value))
	})(...objects);
}
/**
* Get Object type
...
function getReactNodeText(input, options = {}) {
	...
	if (!text) if ((0, import_react.isValidElement)(input) && !Object.values(input.props).length && getObjectType(input.type) === "function") try {
...
function replaceLocaleContent(input, step, steps) {
	...
	if (!(0, import_react.isValidElement)(input)) return input;
	const { children } = input.props;
	if (index_default.string(children) && children.includes("{current}")) return (0, import_react.cloneElement)(input, { children: replacer(children) });
	if (Array.isArray(children)) return (0, import_react.cloneElement)(input, { children: children.map((child) => {
...
function useControls(store, debug, clearFailures) {
	...
	const clearFailuresRef = (0, import_react.useRef)(clearFailures);
...
var skipFields = new Set(["origin", "positioned"]);
...
function useEventEmitter(onEvent, controls, store) {
	...
	return (0, import_react.useCallback)((type, step, overrides) => {
		const data = {
...
function useLifecycleEffect(options) {
	...
	const lastAction = (0, import_react.useRef)(null);
	const propsRef = (0, import_react.useRef)(props);
	const stateRef = (0, import_react.useRef)(state);
	const previousStateRef = (0, import_react.useRef)(previousState);
	const stepRef = (0, import_react.useRef)(step);
	const previousStepRef = (0, import_react.useRef)(previousStep);
	const controlsRef = (0, import_react.useRef)(controls);
	const pollingRef = (0, import_react.useRef)(null);
	const pollingTargetRef = (0, import_react.useRef)(null);
	const beforeRef = (0, import_react.useRef)(null);
...
function usePropSync({ controls, emitEvent, props, state, store }) {
	...
	const previousPropsRef = (0, import_react.useRef)(void 0);
	const stateRef = (0, import_react.useRef)(state);
	const controlsRef = (0, import_react.useRef)(controls);
	stateRef.current = state;
	controlsRef.current = controls;
...
function useScrollEffect({ emitEvent, previousState, props, state, step, store }) {
	...
	const cancelScrollRef = (0, import_react.useRef)(null);
	const stateRef = (0, import_react.useRef)(state);
	const previousStateRef = (0, import_react.useRef)(previousState);
	const propsRef = (0, import_react.useRef)(props);
	const stepRef = (0, import_react.useRef)(step);
...
function useTourEngine(props) {
	...
	const store = (0, import_react.useRef)(createStore(mergedProps));
	...
	const addFailure = (0, import_react.useCallback)((failedStep, reason) => {
		setFailures((previous) => [...previous, {
			reason,
			step: failedStep
		}]);
	}, []);
	const clearFailures = (0, import_react.useCallback)(() => {
		setFailures([]);
	}, []);
	...
	const step = (0, import_react.useMemo)(() => getMergedStep(mergedProps, steps[index]), [
		index,
		mergedProps,
		steps
	]);
...
function JoyrideLoader({ nonce, step }) {
	...
	if (loaderComponent) {
		...
		content = /* @__PURE__ */ import_react.createElement(CustomLoader, { step });
	} else content = /* @__PURE__ */ import_react.createElement("div", { style: {
		...spinnerStyles,
		height,
		width,
...
function useTargetPosition(target, spotlightPadding, force) {
	const [rect, setRect] = (0, import_react.useState)(() => computeRect(target, spotlightPadding));
	const timeoutRef = (0, import_react.useRef)(void 0);
	const scrollParentRef = (0, import_react.useRef)(null);
	const previousForceRef = (0, import_react.useRef)(force);
	const observerRef = (0, import_react.useRef)(null);
	const updateRect = (0, import_react.useCallback)(() => {
...
function JoyrideOverlay(props) {
	...
	const [spotlightReady, setSpotlightReady] = (0, import_react.useState)(false);
	...
	}), coverPath && /* @__PURE__ */ import_react.createElement("path", {
		d: coverPath,
		fill: overlayColor,
		style: {
	...
	}), coverPath && Object.keys(styles.spotlight).length > 0 && /* @__PURE__ */ import_react.createElement("path", {
		d: coverPath,
		fill: "none",
...
function Arrow({ arrowComponent, arrowRef, base, placement, position, size, styles }) {
	...
	if (ArrowComponent) {
		...
		content = /* @__PURE__ */ import_react.createElement("span", { style: { flexShrink: 0 } }, /* @__PURE__ */ import_react.createElement(ArrowComponent, {
			base,
			placement,
			size
		}));
		...
		if (!svg) return null;
		content = /* @__PURE__ */ import_react.createElement("svg", {
			height: svg.height,
			width: svg.width,
			xmlns: "http://www.w3.org/2000/svg"
		}, /* @__PURE__ */ import_react.createElement("polygon", {
			fill: "currentColor",
			points: svg.points
		}));
	}
...
function JoyrideBeacon(props) {
	...
	const beaconRef = (0, import_react.useRef)(null);
	...
	if (beaconComponent) {
		...
		content = /* @__PURE__ */ import_react.createElement(BeaconComponent, {
			continuous,
			index,
			isLastStep,
			size,
	...
	} else content = /* @__PURE__ */ import_react.createElement("span", { style: styles.beacon }, /* @__PURE__ */ import_react.createElement("span", { style: styles.beaconOuter }), /* @__PURE__ */ import_react.createElement("span", { style: styles.beaconInner }));
...
function JoyrideTooltipCloseButton({ styles, ...props }) {
	...
	return /* @__PURE__ */ import_react.createElement("button", {
		...
		xmlns: "http://www.w3.org/2000/svg"
	}, /* @__PURE__ */ import_react.createElement("g", null, /* @__PURE__ */ import_react.createElement("path", {
...
function JoyrideDefaultTooltip(props) {
	...
	if (buttons.includes("primary")) buttonElements.primary = /* @__PURE__ */ import_react.createElement("button", {
		"data-testid": "button-primary",
		style: styles.buttonPrimary,
		type: "button",
		...primaryProps
	});
	if (buttons.includes("skip") && !isLastStep) buttonElements.skip = /* @__PURE__ */ import_react.createElement("button", {
		"aria-live": "off",
	...
	if (buttons.includes("back") && index > 0) buttonElements.back = /* @__PURE__ */ import_react.createElement("button", {
		"data-testid": "button-back",
		style: styles.buttonBack,
		type: "button",
		...backProps
	});
	buttonElements.close = buttons.includes("close") && /* @__PURE__ */ import_react.createElement(JoyrideTooltipCloseButton, {
	...
	return /* @__PURE__ */ import_react.createElement("div", {
		...
		...tooltipProps,
		...ariaProps
	}, /* @__PURE__ */ import_react.createElement("div", { style: styles.tooltipContainer }, title && /* @__PURE__ */ import_react.createElement("h4", {
		id: "joyride-tooltip-title",
		style: styles.tooltipTitle
	}, title), /* @__PURE__ */ import_react.createElement("div", {
		id: "joyride-tooltip-content",
		style: styles.tooltipContent
	}, content)), buttons.some((b) => b === "back" || b === "primary" || b === "skip") && /* @__PURE__ */ import_react.createElement("div", { style: styles.tooltipFooter }, /* @__PURE__ */ import_react.createElement("div", { style: styles.tooltipFooterSpacer }, buttonElements.skip), buttonElements.back, buttonElements.primary), buttonElements.close);
}
function Tooltip(props) {
	...
	if (tooltipComponent) {
		...
		component = /* @__PURE__ */ import_react.createElement(TooltipComponent, {
			...getElementsProps(),
			continuous,
			controls,
			index,
	...
	} else component = /* @__PURE__ */ import_react.createElement(JoyrideDefaultTooltip, {
		...getElementsProps(),
		continuous,
		controls,
		index,
...
function JoyrideFloater(props) {
	...
	const beaconMiddlewareRef = (0, import_react.useRef)({});
	const tooltipMiddlewareRef = (0, import_react.useRef)({});
	const isCenter = step.placement === "center";
	const isAuto = step.placement === "auto";
	const centerReference = (0, import_react.useMemo)(() => ({ getBoundingClientRect: () => ({
	...
	const scrollParent = (0, import_react.useMemo)(() => hasCustomScrollParent(target) ? getScrollParent(target) : void 0, [target]);
	const isFixedTarget = (0, import_react.useMemo)(() => hasPosition(target), [target]);
	const boundaryOptions = (0, import_react.useMemo)(() => scrollParent ? {
	...
	const tooltipMiddleware = (0, import_react.useMemo)(() => isCenter ? [{
		name: "center",
		fn: ({ rects }) => ({
	...
	const beaconFloating = useFloating({
		...
		middleware: (0, import_react.useMemo)(() => [offset(step.floatingOptions?.beaconOptions?.offset ?? -18)], [step.floatingOptions?.beaconOptions?.offset]),
	...
	const handleBeaconInteraction = (0, import_react.useCallback)((event) => {
	...
	const floaterRef = (0, import_react.useCallback)((node) => {
		if (node) {
	...
	if (lifecycle === LIFECYCLE.TOOLTIP || lifecycle === LIFECYCLE.TOOLTIP_BEFORE) {
		...
		content = /* @__PURE__ */ import_react.createElement("div", {
			ref: floaterRef,
			className: "react-joyride__floater",
			"data-testid": "floater",
			id: `react-joyride-step-${index}`,
			style: styles
		}, /* @__PURE__ */ import_react.createElement(Tooltip, {
			continuous,
			controls,
			index,
			...
			size,
			step
		}), !isCenter && !step.floatingOptions?.hideArrow && /* @__PURE__ */ import_react.createElement(Arrow, {
	...
	} else if (lifecycle === LIFECYCLE.BEACON || lifecycle === LIFECYCLE.BEACON_BEFORE) content = /* @__PURE__ */ import_react.createElement("div", {
	...
	}, /* @__PURE__ */ import_react.createElement(JoyrideBeacon, {
	...
	return /* @__PURE__ */ import_react.createElement(JoyridePortal, { element: portalElement }, content);
}
function JoyrideStep(props) {
	...
	const [tooltipElement, setTooltipElement] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ import_react.createElement(JoyrideFloater, {
...
function TourRenderer({ controls, mergedProps, state, step, store }) {
	...
	const [showLoader, setShowLoader] = (0, import_react.useState)(false);
	const loaderTimerRef = (0, import_react.useRef)(null);
	...
	const handleClickOverlay = (0, import_react.useCallback)(() => {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, lifecycle !== LIFECYCLE.INIT && /* @__PURE__ */ import_react.createElement(JoyrideStep, {
		...state,
		continuous,
		controls,
		debug,
	...
	}), /* @__PURE__ */ import_react.createElement(JoyridePortal, { element }, /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, showLoader && /* @__PURE__ */ import_react.createElement(JoyrideLoader, {
		nonce,
		step
	}), !hideOverlay && /* @__PURE__ */ import_react.createElement(JoyrideOverlay, {
		...step,
		continuous,
		lifecycle,
...
function useJoyride(props) {
	...
	return {
		controls,
		failures,
		on: (0, import_react.useCallback)((eventType, handler) => store.current.on(eventType, handler), [store]),
		state: (0, import_react.useMemo)(() => omit(state, "positioned"), [state]),
		step,
		Tour: canUseDOM() ? /* @__PURE__ */ import_react.createElement(TourRenderer, {
			controls,
			mergedProps,
			state,
			step,
...
function Joyride(props) {
	...
	return /* @__PURE__ */ import_react.createElement(JoyrideTour, props);
}
//#endregion
export { Joyride as n, STATUS as r, EVENTS as t };
